  ...
  return (
    <>
      ...
      <div className="[&_a[href='/contact-us']]:!text-white [&_a:first-of-type]:!text-white">
        <HeroSection
          eyebrow="Safe, Clean & Structured Living Environments"
          title="Senior Homemaker & Light Housekeeping Services"
          // OPTIMIZATION: Differentiated button texts to resolve Duplicate Anchor Link penalty
          primaryAction={{ label: "Request Homemaker Services", href: "/contact-us" }}
          secondaryAction={{ label: "Call for Housekeeping: 708-304-0296", href: "tel:7083040296" }}
            ...
            <div className="space-y-6">
              ...
              <ScrollReveal>
                ...
                <p className="text-sm sm:text-base leading-relaxed text-slate-700">
                  An organized space contributes to a sense of clarity and routine. Our <strong>senior homemaker & light housekeeping services</strong> focus on maintaining a tidy and functional environment with attention to the details that matter most. Whether it’s handling daily tasks or addressing specific household needs, efficiency and comfort are prioritized.
                </p>
              </ScrollReveal>
              
              <ScrollReveal>
                <p className="text-sm sm:text-base leading-relaxed text-slate-700">
                  A clean home brings peace of mind, comfort, and a renewed sense of well-being. Let our home maker take care of the daily chores. If you are looking for reliable <strong>light housekeeping services</strong>, we know that every home is unique, and we tailor our support to fit individual preferences. We prioritize specific cleaning tasks, whether it’s keeping the kitchen spotless, making the bedroom a cozy retreat, or ensuring that bathrooms remain fresh and sanitized.
                </p>
              </ScrollReveal>
                ...
                <div className="mt-8 pt-6 border-t border-slate-200/60">
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start gap-3.5 text-slate-700 text-sm sm:text-base">
                      ...
                      <span>Keeping living spaces tidy, accessible, and free from clutter to prevent falls.</span>
                    </li>
                  </ul>
                </div>
              </ScrollReveal>
            ...
            <div className="mx-auto max-w-3xl text-center space-y-6">
              ...
              <div className="pt-4 flex flex-wrap justify-center gap-4">
                ...
                >
                  ...
                  <span className="sr-only"> with Light Housekeeping</span>
