    ...
    <>
      ...
      <div className="[&_a[href='/contact-us']]:!text-white [&_a:first-of-type]:!text-white">
        <HeroSection
          ...
          primaryAction={{ label: "Request Meal Prep Support", href: "/contact-us" }}
          secondaryAction={{ label: "Call for Meal Services", href: "tel:7083040296" }}
            ...
            <div className="space-y-6">
              ...
              <ScrollReveal>
                ...
                <p className="text-sm sm:text-base leading-relaxed text-slate-700">
                  Proper nutrition and thoughtful meal planning are essential for overall well-being. Our dedicated <strong>in-home senior meal preparation services</strong> ensure that every meal is handled with care, precision, and consideration of individual preferences.
                </p>
              </ScrollReveal>
              
              <ScrollReveal>
                <p className="text-sm sm:text-base leading-relaxed text-slate-700">
                  From preparation to assistance, every detail is managed efficiently. Our approach to in-home care in Westchester, Illinois, promotes consistency and attention to dietary needs. It&apos;s about making daily nutrition straightforward and effective. If you are seeking reliable <strong>senior meal preparation services</strong>, our team is ready to help.
                </p>
              </ScrollReveal>
                ...
                <div className="mt-8 pt-6 border-t border-slate-200/60">
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start gap-3.5 text-slate-700 text-sm sm:text-base">
                      ...
                      <span>Providing assistance with feeding when required to ensure a dignified experience.</span>
                    </li>
                  </ul>
                </div>
              </ScrollReveal>
            ...
            <div className="mx-auto max-w-3xl text-center space-y-6">
              ...
              <div className="pt-4 flex flex-wrap justify-center gap-4">
                ...
                >
                  ...
                  <span className="sr-only"> with Meal Preparation</span>
