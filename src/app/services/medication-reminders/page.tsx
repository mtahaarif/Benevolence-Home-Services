    ...
    <>
      ...
      <div className="[&_a[href='/contact-us']]:!text-white [&_a:first-of-type]:!text-white">
        <HeroSection
          ...
          secondaryAction={{ label: "Call for Reminders: 708-304-0296", href: "tel:7083040296" }}
        ...
        <PageShell>
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
            ...
            <div className="space-y-6">
              ...
              <ScrollReveal>
                {/* OPTIMIZATION: Exact H1 and Title phrases seamlessly injected to resolve Content Match penalty */}
                <p className="text-sm sm:text-base leading-relaxed text-slate-700">
                  Consistency and accuracy are essential when it comes to maintaining health routines. By providing dependable <strong>in-home medication reminders for seniors</strong>, this service ensures schedules are followed, and routines remain uninterrupted. Every detail is managed with precision, minimizing the risk of oversight. 
                </p>
              </ScrollReveal>
              
              <ScrollReveal>
                <p className="text-sm sm:text-base leading-relaxed text-slate-700">
                  Medication non-adherence can lead to worsening health conditions, hospitalizations, or complications. Our healthcare services ensure that our clients receive regular, dependable reminders without feeling overwhelmed. Our team prioritizes clear communication and dependable support, reinforcing routines with attention and care.
                </p>
              </ScrollReveal>
            ...
            <div className="mx-auto max-w-3xl text-center space-y-6">
              ...
              <div className="pt-4 flex flex-wrap justify-center gap-4">
                ...
                >
                  ...
                  <span className="sr-only"> with Medication Reminders</span>
