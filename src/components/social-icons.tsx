/**
 * Inline replacements for the five `react-icons/fa` glyphs the footer used.
 *
 * react-icons has no per-icon entry points, so importing five faces pulled a
 * large module into the client bundle on every route — and, because the icons
 * were referenced from a component tree marked "use client", it could not be
 * tree-shaken away. These are plain server-rendered SVGs.
 */
